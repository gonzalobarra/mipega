...
def registro_view(request):
	...
	if request.POST and form_user.is_valid():
		...
		usuario = User(username=form_user.cleaned_data['username'], password=form_user.cleaned_data['password'])
		usuario.save()
